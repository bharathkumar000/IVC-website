                ...
                >
                    {projects.map((project) => (
                        <motion.div
                            key={project.id}
                            variants={item}
                            className="bg-white/5 border border-white/10 rounded-xl overflow-hidden hover:border-ivc-primary/50 transition-colors group hover:shadow-lg hover:shadow-ivc-primary/10"
                        >
                            ...
                            <div className="p-6">
                                <h3 className="text-xl font-bold mb-2 group-hover:text-ivc-accent transition-colors text-white">{project.title}</h3>
